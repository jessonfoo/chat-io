...
var RUNNING_PORT = 80; // <- if you change this, you need to change in public/js/app.js and recompile // var lrSnippet = require('connect-livereload')({port: LIVERELOAD_PORT});
